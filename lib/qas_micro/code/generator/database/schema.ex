defmodule QasMicro.Code.Generator.Database.Schema do
  ...
  defp render_schema_template(config_module, object, header) do
    ...
    |> EEx.eval_string(
      ...
      field_expressions: QasMicro.Code.Generator.Database.Field.render(object),
      index_expressions: QasMicro.Code.Generator.Database.Index.render(object, header)
    )
